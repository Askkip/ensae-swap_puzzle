...
class Test_SolutionGrapheAstarMan(unittest.TestCase):
    def test_solution_graphe(self):
        ...
        solv3=Solver(grid3)
        solv4=Solver(grid4)
        res0= solv0.get_solution_graphe_a_star(Graph.manhattan)
        res1= solv1.get_solution_graphe_a_star(Graph.manhattan)
        res2= solv2.get_solution_graphe_a_star(Graph.manhattan)
        res3= solv3.get_solution_graphe_a_star(Graph.manhattan)
        res4= solv4.get_solution_graphe_a_star(Graph.manhattan)
